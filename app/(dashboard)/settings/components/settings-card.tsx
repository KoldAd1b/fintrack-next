...
import { SubscriptionCheckout } from "@/features/subscriptions/components/subsciption-checkout";
...
const SettingsCard = (props: Props) => {
  ...
  if (isLoadingConnectedBank || subscription.isLoading) {
    return (
  ...
  return (
    <Card className="border-none drop-shadow-sm">
      <CardHeader>
        <CardTitle className="text-xl line-clamp-1"></CardTitle>
      </CardHeader>
      <CardContent>
        <Separator />
